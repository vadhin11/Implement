...
![](picture/provisioning_VM_2.png)

Click Power on VM:

select `Install Oracle Linux 9.6.0`

![](picture/Install_Oracle_Linux_9.png)

`Welcome to Oracle Linux 9.6` installation : then press continue ([ref-link](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/))

![](picture/welcome_to_Oracle_Linux.png)

[document](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-InstallingOracleLinuxinGraphicsMode.html#graphics-mode)

![](picture/Installation_summary_init.png)

### Installation destination [link](https://docs.oracle.com/en/operating-systems/oracle-linux/9/install/install-DefaultDiskPartitionLayout.html)
...
after finish install press `Reboot System`
